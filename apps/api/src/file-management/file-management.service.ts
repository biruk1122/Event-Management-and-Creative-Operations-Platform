...
/**
 * Owns the current Event implementation of FIL-02. Future parent modules add
 * their own explicit attachment surface; this service deliberately does not
 * accept an entity type/id pair or expose storage keys.
 */
@Injectable()
