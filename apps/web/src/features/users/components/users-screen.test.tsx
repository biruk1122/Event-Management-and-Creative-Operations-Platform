...
describe("UsersScreen access boundary", () => {
  it("renders the manager once user.read is confirmed", async () => {
    setup();
  ...
  it("drops to the session-expired state and clears user cache", async () => {
    const client = setup();
